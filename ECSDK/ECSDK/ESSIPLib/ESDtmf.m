...
/**
 */
void sip_call_play_digits(int call_id, void *digitsValue)
{
    pj_str_t *digits = (pj_str_t *)digitsValue;
    pj_status_t status;
    ...
    if (status == PJMEDIA_RTP_EREMNORFC2833)
    {
        ...
        d = (pjmedia_tone_digit *)pj_pool_calloc (cd->pool, digits->slen, sizeof(pjmedia_tone_digit));
...
/**
 */
void sip_call_play_info_digits(int call_id, void *digitsValue)
{
    pj_str_t *digits = (pj_str_t *)digitsValue;
